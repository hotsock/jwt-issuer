...
| Asia Pacific (Malaysia)   | ap-southeast-5 | [Launch Stack](https://console.aws.amazon.com/cloudformation/home?region=ap-southeast-5#/stacks/new?stackName=JWTIssuer&templateURL=https://jwt-issuer-stack-templates-ap-southeast-5.s3.ap-southeast-5.amazonaws.com/jwt-issuer-v1.x.yml) |
...
| Asia Pacific (Thailand)   | ap-southeast-7 | [Launch Stack](https://console.aws.amazon.com/cloudformation/home?region=ap-southeast-7#/stacks/new?stackName=JWTIssuer&templateURL=https://jwt-issuer-stack-templates-ap-southeast-7.s3.ap-southeast-7.amazonaws.com/jwt-issuer-v1.x.yml) |
...
| Mexico (Central)          | mx-central-1   | [Launch Stack](https://console.aws.amazon.com/cloudformation/home?region=mx-central-1#/stacks/new?stackName=JWTIssuer&templateURL=https://jwt-issuer-stack-templates-mx-central-1.s3.mx-central-1.amazonaws.com/jwt-issuer-v1.x.yml)       |
